	...
	<thead>
		<tr>
			<td class="month_name" colspan="7">
				...
				<a class="em-calnav em-calnav-prev" href="<?php echo $calendar['links']['previous_url']; ?>" rel="nofollow">&nbsp;</a>
				<a class="em-calnav em-calnav-next" href="<?php echo $calendar['links']['next_url']; ?>" rel="nofollow">&nbsp;</a>
			</td>
		</tr>
	</thead>
	<tbody>
