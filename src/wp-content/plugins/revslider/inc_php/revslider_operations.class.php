...
<?php
			...
			<?php _e('Copy to header:', REVSLIDER_TEXTDOMAIN); ?>
			<textarea id="rev_head_content" readonly="true" style="width: 100%; height: 150px;"><?php echo $head_content; ?></textarea>
			<?php _e('Copy to CSS:', REVSLIDER_TEXTDOMAIN); ?>
			<textarea id="rev_style_content" readonly="true" style="width: 100%; height: 150px;"><?php echo $style_content; ?></textarea>
			<?php _e('Copy to body:', REVSLIDER_TEXTDOMAIN); ?>
			<textarea id="rev_the_content" readonly="true" style="width: 100%; height: 150px;"><?php echo $content; ?></textarea>
			<?php _e('Copy to script:', REVSLIDER_TEXTDOMAIN); ?>
			<textarea id="rev_script_content" readonly="true" style="width: 100%; height: 150px;"><?php echo $script_content; ?></textarea>
			</body>
			</html>
			<?php
			exit();
