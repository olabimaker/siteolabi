<?php
	...
	add_image_size( 'blog-featured'	,772	,301	,true 	);
	// add_image_size( 'blog-featured-large'	,1170	,380	,true 	);
	// add_image_size( 'blog-featured-small'	,575	,280	,true 	);
		...
		<li <?php comment_class(); ?> id="li-comment-<?php comment_ID(); ?>">
			<div class="comment-body">
				...
				<div class="comment-author vcard">
					...
					<cite class="fn">
						<a class="url" rel="external nofollow" href="#"><?php comment_author();  ?></a>
					</cite>
					<span class="says"><?php  echo __( 'says', EWF_SETUP_THEME_DOMAIN )  ?>:</span>
				</div>
					
				<div class="comment-meta commentmetadata">
					<strong><?php comment_date('d M Y'); ?></strong>
				</div>
